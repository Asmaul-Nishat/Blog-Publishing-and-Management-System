...
<title>Blogger Dashboard - Blogg</title>
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav>
      <a href="blogger-dashboard.php" class="active"><span class="icon">🏠</span> Dashboard</a>
      <a href="manage-posts.php"><span class="icon">📝</span> Manage Posts</a>
      <a href="manage-comments.php"><span class="icon">💬</span> Comments</a>
      <a href="profile-setting.php"><span class="icon">⚙️</span> Profile Settings</a>
